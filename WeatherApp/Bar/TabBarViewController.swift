...
class TabBarViewController: UITabBarController {
    ...
    // controllers
    private var weatherTodayVC = WeatherTodayViewController()
    private var weaherWeekTVC = WeatherWeekViewController()
...
private extension TabBarViewController {
    ...
    func setupViews() {
        setViewControllers([weatherTodayVC, weaherWeekTVC], animated: true)
        setupCustomBar()
