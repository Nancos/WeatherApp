...
private extension WeatherCell {
    ...
    func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            timeLabel.leftAnchor.constraint(equalTo: weatherImageView.rightAnchor, constant: 15),
            // clouds label
            cloudsLabel.topAnchor.constraint(equalTo: timeLabel.bottomAnchor, constant: 10),
            cloudsLabel.leftAnchor.constraint(equalTo: weatherImageView.rightAnchor, constant: 15),
            // temp label
